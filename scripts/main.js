...
function simBattle(battleInfo, displayMsg) {
    ...
    if (battleInfo.attacker.weaponName === "None") {
        if (displayMsg) {
            $("#interaction-list").stop(true, true).hide().html("<li class='battle-interaction-only'><span class='attacker'>" + attacker.display + "</span> cannot attack without a weapon.</li>");
